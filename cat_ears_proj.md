...
![image of me wearing the ears](./img/1.jpg)
...
![Sketches of the designs](./img/2.jpg)
...
![Image of the planned components](./img/3.jpg)
...
![Gif from stream of cutting some foam](./img/4.gif)
...
![Picture of wire harness](./img/5.jpg)


## Program Design

![Gif of starting the code during the stream](./img/6.gif)
...
![Gif from the stream of me struggling with the program](./img/7.gif)
...
![Gif of the ears behaving erratically to a standard beat. maybe a youtube clip?](./img/8.gif)
...
![Gif of the performance on the desk](./img/9.gif)
